...
! function(t) {
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function(t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.underscoreEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var T, O = "resize.underscore orientationchange.underscore load.underscore";
    ...
    r.resize = b(c, O), r.scroll = b(c, "scroll.underscore resize.underscore orientationchange.underscore load.underscore"), r.redraw = b(), r.location = function(t) {
        window.location = t
    ...
    }, u(r.ready), S(), t.exports = window.underscore = r
}, function(t, e, n) {
    "use strict";
    var r = n(13);
    Object.defineProperty(e, "__esModule", {
    ...
    var r = window.$,
        i = n(64) && r.tram;
    /*!
     * Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    r.define("edit", t.exports = function(t, e, n) {
        ...
        var i, o = t(window),
            ...
            c = "hashchange",
            s = n.load || function() {
                i = !0, window.underscoreEditor = !0, o.off(c, l),
                    function(t) {
                        var e = window.document.createElement("iframe");
                        e.src = "https://underscore.com/site/third-party-cookie-check.html", e.style.display = "none", e.sandbox = "allow-scripts allow-same-origin";
                        var n = function n(r) {
                        ...
                        t.ajax({
                            url: E("https://editor-api.underscore.com/api/editor/view"),
                            data: {
            ...
            f = !1;
        try {
            f = localStorage && localStorage.getItem && localStorage.getItem("underscoreEditor")
        } catch (t) {}
        ...
        function h(t) {
            return t.indexOf("//") >= 0 ? t : E("https://editor-api.underscore.com" + t)
        }
    ...
    e.createPluginInstance = function(t) {
        var e = window.underscore.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function(t) {
        window.underscore.require("lottie").createInstance(t).stop()
    }
}, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
...
underscore.require('ix2').init({
    "events": {
        ...
        "e-24": {
            ...
            "target": {
                "selector": ".para001",
                "originalId": "kimtrongData|Paragraph",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".para001",
        ...
        "e-26": {
            ...
            "target": {
                "selector": ".heading001",
                "originalId": "kimtrongData|Heading 3",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".heading001",
        ...
        "e-28": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "kimtrongData|ffe658df-91fa-131d-52dd-faf4b6454857",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-30": {
            ...
            "target": {
                "id": "kimtrongData|89573d2d-5b3e-7678-3c70-5359e3c634fd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-32": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "kimtrongData|0eca294e-b796-3ca9-f62b-a9b5ab322a19",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-34": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "kimtrongData|c47c8069-3458-03e4-d04e-8e92599f1a04",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-36": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "kimtrongData|e22418ff-eeaa-07de-7636-18ef037ef881",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-38": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "kimtrongData|79ebe4b6-7a0d-c1e4-55c1-ec839f7559c3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".things",
                                "selectorGuids": ["be70eecb-e107-4980-7fcd-f24041fe2eef"]
                            },
                            "xValue": null,
                            "yValue": 0,
                            "xUnit": "px",
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".tenlua",
                                "selectorGuids": ["ca610d7f-4aa6-5365-74b2-68678bbf2db7"]
                            },
                            "xValue": 0,
                            "yValue": 0,
                            "xUnit": "px",
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".may",
                                "selectorGuids": ["bc7aa8de-40c8-e261-1dd5-202da84fa575"]
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "px",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".sbb",
                                "selectorGuids": ["7074695f-1fbf-64ac-3695-e0fd7dfd7175"]
                            },
                            "value": 1,
                            "unit": ""
                        }
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".tron1",
                                "selectorGuids": ["2c2222bc-8a72-bc14-5f35-3d3503e13507"]
                            },
                            "xValue": 1,
                            "yValue": 1,
                            "locked": true
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".body",
                                "selectorGuids": ["b15efd32-a54d-264e-427e-103203982990"]
                            },
                            "globalSwatchId": "",
                            "rValue": 232,
                            "bValue": 232,
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selector": ".none",
                                "selectorGuids": ["f45ae23a-f25e-e27a-bd3e-b0fd2bc26336"]
                            },
                            "yValue": -153,
                            "xUnit": "PX",
                            "yUnit": "px",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".body2",
                                "selectorGuids": ["9796661a-6621-bfb2-818e-0b997858fca5"]
                            },
                            "globalSwatchId": "",
                            "rValue": 0,
                            "bValue": 0,
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".p1",
                                "selectorGuids": ["9865d696-550a-dd2e-1dc8-cd93ecc505c9"]
                            },
                            "yValue": -155,
                            "xUnit": "PX",
                            "yUnit": "px",
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".p3",
                                "selectorGuids": ["e1d6cc8d-7b80-d22c-add0-b008b918b61e"]
                            },
                            "yValue": -150,
                            "xUnit": "PX",
                            "yUnit": "px",
                        ...
                        "config": {
                            ...
                            "target": {
                                "selector": ".p2",
                                "selectorGuids": ["34e44298-7f3e-4471-de89-a3d78fb73ae5"]
                            },
                            "yValue": -170,
                            "xUnit": "PX",
                            "yUnit": "px",
